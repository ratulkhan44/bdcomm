    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                <form method="POST" action="{{route('admin.pourosava.update',$pourosava->id)}}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                                <label for="name" class="col-sm-4 col-form-label">Pourosava</label>
                                <div class="col-sm-8">
                                <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="{{$pourosava->name}}" required>
                                </div>
                        </div>
