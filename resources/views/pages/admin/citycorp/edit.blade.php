    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                <form method="POST" action="{{route('admin.citycorp.update',$citycorp->id)}}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="{{$citycorp->name}}" required>
                                </div>
                        </div>
